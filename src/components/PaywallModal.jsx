      ...
      <div className="bg-white rounded-lg shadow-2xl p-8 max-w-md w-full">
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-serif font-bold text-gray-900 mb-2">
            You've Used Your 3 Free Dilemmas
          </h2>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
          <p className="text-center">
            ...
            <span className="text-gray-600 text-sm"> (first 100 users)</span>
          </p>
          <p className="text-center text-xs text-gray-600 mt-1">
            Regular price: $39 (lifetime access)
          </p>
        </div>

        <button
          onClick={onUpgrade}
          className="w-full bg-amber-700 hover:bg-amber-800 text-white font-semibold py-3 px-6 rounded-lg transition-colors mb-3"
        >
          Upgrade Now
        </button>
